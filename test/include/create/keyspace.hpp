...
namespace jest
{
  ...
  template <> template <>
  void casst::create_keyspace_group::test<2>() /* and_durable_writes */
  {
  ...
  template <> template <>
  void casst::create_keyspace_group::test<3>() /* network topology */
  {
    std::string const str{ casst::create::keyspace<casst::create::if_not_exists>("cmb_tables").
  ...
  template <> template <>
  void casst::create_keyspace_group::test<4>() /* network topology more data centers */
  {
    std::string const str{ casst::create::keyspace<casst::create::if_not_exists>("cmb_tables").
